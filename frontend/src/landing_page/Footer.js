            ...
            <div className='row mt-5 '>
                ...
                <div className='col'>
                    <p>Company</p>
                        ...
                        <br/>
                        <a href='' className="text-muted"style={{textDecoration:"none"}}>Product</a>
                        <br/>
                ...
                <div className='col'>
                    ...
                    <br/>
                    <a href='' className="text-muted"style={{textDecoration:"none"}}>Downloads & resorces</a>
                    <br/>
                </div>
                <div className='col'>
                    <p>Account</p>
                    <a href=''className="text-muted" style={{textDecoration:"none"}}>Open a account</a>
                    <br/>
...
of the day. Issued in the interest of investors. KYC is one time exercise 
while dealing in securities markets – once KYC is done through a SEBI 
registered intermediary (broker, DP, Mutual Fund etc.), you need not 
undergo the same process again when you approach another intermediary. 
Dear Investor, if you are subscribing to an IPO, there is no need to issue 
a cheque. Please write the Bank account number and sign the IPO 
